      ...
      <div className="h-screen flex-column">
        ...
        <div className="bg-gray-200 sm:py-6 sm:px-12 py-3 px-6 flex-grow">
          ...
          <div className="content-div bg-white rounded grid lg:grid-cols-2 grid-cols-1">
            ...
            <div className="grid grid-cols-1 pb-8 lg:pl-8 pt-4 pr-4 pl-4">
                  ...
                  <div className="bg-white rounded flex-grow my-4 mx-8 relative previous-score-white">
                    ...
                    >
                      <div className="flex flex-col justify-end">
                        <div className="h-3/6 bottom-0 bg-gray-300 rounded shadow shadow-gray-400">
                          <div className="relative names font-semibold text-center">
                            {quizOneDisplayScores[1] &&
                              quizOneDisplayScores[1].quizUser}
                          </div>
                          <div className="text-center top-score-details">
                            {quizOneDisplayScores[1] &&
                              Object.values(quizOneDisplayScores)[1]
                                .quizResults}
                            /
                            {quizOneDisplayScores[1] &&
                      ...
                      <div className="flex flex-col justify-end">
                        <div className="h-4/6 bottom-0 first-place bg-gray-300 rounded shadow-md shadow-gray-400">
                          <div className="relative names font-semibold text-center">
                            {quizOneDisplayScores[0] &&
                              quizOneDisplayScores[0].quizUser}{" "}
                          </div>
                          <div className="text-center top-score-details">
                            {" "}
                            {quizOneDisplayScores[0] &&
                              Object.values(quizOneDisplayScores)[0]
                                .quizResults}
                            /
                            {quizOneDisplayScores[0] &&
                              Object.values(quizOneDisplayScores)[0]
                          ...
                          <div className="text-center mt-2 text-sm top-score-details">
                            {quizOneDisplayScores[0] &&
                              formatDate(
                                Object.values(quizOneDisplayScores)[0].date
                              )}{" "}
                          </div>{" "}
                        </div>
                      </div>
                      <div className="flex flex-col justify-end">
                        <div className="h-2/6 bottom-0 third-place bg-gray-300 rounded shadow-sm shadow-gray-400">
                          <div className="relative names font-semibold text-center">
                            {quizOneDisplayScores[2] &&
                              quizOneDisplayScores[2].quizUser}{" "}
                          </div>
                          <div className="text-center top-score-details">
                            {quizOneDisplayScores[2] &&
                              Object.values(quizOneDisplayScores)[2]
                                .quizResults}
                            /
                            {quizOneDisplayScores[2] &&
                              Object.values(quizOneDisplayScores)[2]
                          ...
                          <div className="text-center mt-2 text-sm top-score-details">
                            {quizOneDisplayScores[2] &&
                              formatDate(
                                Object.values(quizOneDisplayScores)[2].date
                              )}{" "}
                          </div>{" "}
                        </div>
                      </div>
                    ...
                    >
                      <div className="flex flex-col justify-end">
                        <div className="h-3/6 bottom-0 bg-gray-300 rounded shadow shadow-gray-400">
                          <div className="relative names font-semibold text-center">
                            {quizTwoDisplayScores[1] &&
                              quizTwoDisplayScores[1].quizUser}{" "}
                          </div>
                          <div className="text-center top-score-details">
                            {quizTwoDisplayScores[1] &&
                              Object.values(quizTwoDisplayScores)[1]
                                .quizResults}
                            /
                            {quizTwoDisplayScores[1] &&
                              Object.values(quizTwoDisplayScores)[1]
                          ...
                          <div className="text-center mt-2 text-sm top-score-details">
                            {quizTwoDisplayScores[1] &&
                              formatDate(
                                Object.values(quizTwoDisplayScores)[1].date
                              )}
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col justify-end">
                        <div className="h-4/6 bottom-0 first-place bg-gray-300 rounded shadow-md shadow-gray-400">
                          <div className="relative names font-semibold text-center">
                            {quizTwoDisplayScores[0] &&
                              quizTwoDisplayScores[0].quizUser}{" "}
                          </div>
                          <div className="text-center top-score-details">
                            {quizTwoDisplayScores[0] &&
                              Object.values(quizTwoDisplayScores)[0]
                                .quizResults}
                            /
                            {quizTwoDisplayScores[0] &&
                              Object.values(quizTwoDisplayScores)[0]
                          ...
                          <div className="text-center mt-2 text-sm top-score-details">
                            {quizTwoDisplayScores[0] &&
                              formatDate(
                                Object.values(quizTwoDisplayScores)[0].date
                              )}{" "}
                          </div>{" "}
                        </div>
                      </div>
                      <div className="flex flex-col justify-end">
                        <div className="h-2/6 bottom-0 third-place bg-gray-300 rounded shadow-sm shadow-gray-400">
                          <div className="relative names font-semibold text-center">
                            {quizTwoDisplayScores[2] &&
                              quizTwoDisplayScores[2].quizUser}{" "}
                          </div>
                          <div className="text-center top-score-details">
                            {quizTwoDisplayScores[2] &&
                              Object.values(quizTwoDisplayScores)[2]
                                .quizResults}
                            /
                            {quizTwoDisplayScores[2] &&
                              Object.values(quizTwoDisplayScores)[2]
                          ...
                          <div className="text-center mt-2 text-sm top-score-details">
                            {quizTwoDisplayScores[2] &&
                              formatDate(
                                Object.values(quizTwoDisplayScores)[2].date
                              )}{" "}
                          </div>{" "}
                        </div>
                      </div>
